      ...
      <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="insert.php">Ajout carte,menu ou plat</a>
              </li><br>
              <li class="nav-item">
                <a class="nav-link" href="update.php">mise a jour des carte,menu ou plat</a>
              </li>
            </ul>
          </div>
        </nav>

        <h1 class="text-logo"><span class="glyphicon glyphicon-cutlery"></span> Restologue<span class="glyphicon glyphicon-cutlery"></span></h1>
